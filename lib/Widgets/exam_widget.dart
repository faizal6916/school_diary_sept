          ...
          children: [
            Container(
             ...
             // color: Colors.green,
              ...
              child: Center(child: Text('${DateFormat('dd MMM').format(DateTime.parse(widget.date!.split(' ')[0]))}')),
            ),
            Column(children: [
              Container(
                width: 1.sw - 130,
                           ...
                           // color: Colors.grey,
                            child: Row(
                              ...
                              children: [
                                ...
                                child: Center(child: Text(widget.markObt!)),
                                ),
